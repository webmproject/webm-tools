...
class WebMFile {
 public:
  ...
  // |bytes_read| on the next call to ParseNextChunk. If |bytes_read| is -1
  // |data| must not be changed on subsequent calls to ParseNextChunk. Returns
  // the current state of the parser or returns kParsingError if the parser
