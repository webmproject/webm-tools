...
class WebmIncrementalReader : public mkvparser::IMkvReader {
 public:
  ...
  // Sets the offset to the end of the segment. |offset| is the end of the
  // segment in bytes. Returns true on success.
  bool SetEndOfSegmentPosition(int64 offset);
 ...
 private:
  ...
  // TODO(fgalligan) Can I change this to int64?
  ...
  // The end of the segment. -1 represents the end of the segment is unknown.
