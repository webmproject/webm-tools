...
class CVPixelBufferWrap {
 public:
  ...
  ~CVPixelBufferWrap() { if (buffer_) CVPixelBufferRelease(buffer_); }
...
- (const GLfloat *)squareVerticesForCurrentOrientation {
  ...
  if (orientation == UIInterfaceOrientationLandscapeLeft) {
    static const GLfloat squareVerticesLandscapeLeft[] = {
      -1,  1,
      -1, -1,
      1,  1,
      1, -1,
    };
    squareVertices = squareVerticesLandscapeLeft;
  } else if (orientation == UIInterfaceOrientationLandscapeRight) {
    // TODO(tomfinegan): Correct these-- they're for landscape left.
    static const GLfloat squareVerticesLandscapeRight[] = {
      -1,  1,
      -1, -1,
      1,  1,
      1, -1,
    };
    squareVertices = squareVerticesLandscapeRight;
    ...
    squareVertices = squareVerticesPortrait;
  } else {
    // UIInterfaceOrientationPortraitUpsideDown
    // TODO(tomfinegan): Correct these-- they're for right side up.
    static const GLfloat squareVerticesPortraitUpsideDown[] = {
      -1,  1,
      -1, -1,
      1,  1,
      1, -1,
    };
    squareVertices = squareVerticesPortraitUpsideDown;
  }
...
- (const GLfloat *)textureVerticesForCurrentOrientation {
  ...
  if (orientation == UIInterfaceOrientationLandscapeLeft) {
    static const GLfloat textureVerticesLandscapeLeft[] = {
      0, 0,
      0, 1,
      1, 0,
      1, 1,
    ...
    // TODO(tomfinegan): Correct these-- they're for landscape left.
    static const GLfloat textureVerticesLandscapeRight[] = {
      0, 0,
      0, 1,
      1, 0,
      1, 1,
    ...
    static const GLfloat textureVerticesPortrait[] = {
      1, 1,
      1, 0,
      0, 1,
      0, 0,
    ...
    // UIInterfaceOrientationPortraitUpsideDown
    // TODO(tomfinegan): Correct these-- they're for right side up.
    static const GLfloat textureVerticesPortraitUpsideDown[] = {
      1, 1,
      1, 0,
      0, 1,
      0, 0,
...
- (void)update {
  ...
  if ([_lock tryLock] == YES) {
    if (_videoBuffers.empty()) {
      ...
      //      buffer.reset(_videoBuffers.front());
