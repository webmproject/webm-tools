...
+ (NSDictionary*)buildExpectedDASHManifestDictionary {
  // Note: For the sake of brevity not all manifest values are encoded in the
  // dictionaries produced here. Instead, only certain representations from each
  // input manifest are verified. Note that this is only the case when a
  ...
  NSDictionary* const audio_rep = [[NSDictionary alloc]
      initWithObjectsAndKeys:
          @"4", @"repID",
          [NSNumber numberWithInt:109755], @"bandwidth",
          [NSNumber numberWithInt:0], @"width",
          [NSNumber numberWithInt:0], @"height",
          [NSNumber numberWithInt:0], @"audioSamplingRate",
          [NSNumber numberWithInt:0], @"audioChannelConfig",
          [NSNumber numberWithInt:0], @"startWithSAP",
          @"glass_171.webm", @"baseURL",
          [NSNull null], @"codecs",
          [NSArray arrayWithObjects:[NSNumber numberWithInt:1839501],
          [NSNumber numberWithInt:1840056], nil],
          @"segmentBaseIndexRange",
          [NSArray arrayWithObjects:[NSNumber numberWithInt:0],
          [NSNumber numberWithInt:4700], nil],
          @"initializationRange",
          nil];

  NSDictionary* const audio_as = [[NSDictionary alloc]
      initWithObjectsAndKeys:
      @"1", @"setID",
      kMimeTypeWebmAudio, @"mimeType",
      kCodecVorbis, @"codecs",
      [NSNumber numberWithInt:1], @"subsegmentAlignment",
      [NSNumber numberWithInt:0], @"bitstreamSwitching",
      [NSNumber numberWithInt:1], @"subsegmentStartsWithSAP",
      [NSNumber numberWithInt:0], @"width",
      [NSNumber numberWithInt:0], @"height",
      [NSNumber numberWithInt:44100], @"audioSamplingRate",
      [NSArray arrayWithObjects:audio_rep, nil], @"representations",
      nil];

  NSDictionary* const video_rep = [[NSDictionary alloc]
      initWithObjectsAndKeys:
          @"0", @"repID",
          [NSNumber numberWithInt:204463], @"bandwidth",
          [NSNumber numberWithInt:406], @"width",
          [NSNumber numberWithInt:240], @"height",
          [NSNumber numberWithInt:0], @"audioSamplingRate",
          [NSNumber numberWithInt:0], @"audioChannelConfig",
          [NSNumber numberWithInt:0], @"startWithSAP",
          @"glass_242.webm", @"baseURL",
          [NSNull null], @"codecs",
  ...
  NSDictionary* const video_as = [[NSDictionary alloc]
      initWithObjectsAndKeys:
          @"0", @"setID",
          kMimeTypeWebmVideo, @"mimeType",
          kCodecVP9, @"codecs",
          [NSNumber numberWithInt:1], @"subsegmentAlignment",
          [NSNumber numberWithInt:1], @"bitstreamSwitching",
          [NSNumber numberWithInt:1], @"subsegmentStartsWithSAP",
          [NSNumber numberWithInt:0], @"width",
          [NSNumber numberWithInt:0], @"height",
          [NSNumber numberWithInt:0], @"audioSamplingRate",
          [NSArray arrayWithObjects:video_rep, nil], @"representations",
          nil];

  NSDictionary* const period = [[NSDictionary alloc]
      initWithObjectsAndKeys:
          @"0", @"periodID",
          [NSArray arrayWithObjects:audio_as, nil], @"audioAdaptationSets",
          [NSArray arrayWithObjects:video_as, nil], @"videoAdaptationSets",
          nil];

  NSDictionary* const manifest = [[NSDictionary alloc]
      initWithObjectsAndKeys:@"PT135.629S", @"mediaPresentationDuration",
                             @"PT1S", @"minBufferTime",
                             [NSNumber numberWithInt:1], @"staticPresentation",
                             period, @"period",
                             nil];
  NSDictionary* const manifest_holder = [[NSDictionary alloc]
      initWithObjectsAndKeys:manifest, kVP9VorbisDASHMPD1URLString, nil];
