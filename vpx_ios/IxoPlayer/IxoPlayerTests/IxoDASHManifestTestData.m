...
+ (IxoMutableDASHManifest*)getVP9VorbisDASHMPD1Manifest {
  ...
  NSMutableArray* const audio_reps =
      [[NSMutableArray alloc] initWithObjects:[audio_rep copy], nil];
  ...
  [audio_reps addObject:audio_rep];
  audio_as.representations = audio_reps;
  ...
  NSMutableArray* const video_reps =
      [[NSMutableArray alloc] initWithObjects:[video_rep copy], nil];
  ...
  video_rep.initializationRange = @[ @0, @441 ];
  [video_reps addObject:[video_rep copy]];
  ...
  [video_reps addObject:[video_rep copy]];
  video_as.representations = video_reps;
