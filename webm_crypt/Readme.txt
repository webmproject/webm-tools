...
4. Build libwebm.
5. Open environment.props file and change CHROMIUM_INC's value to your
...
- Windows only works in "Debug DLL" configuration.
  http://code.google.com/p/webm/issues/detail?id=464
